...
import pe.edu.cibertec.DSWII_CL3_BeltranLopez.model.response.UsuarioResponse;
import pe.edu.cibertec.DSWII_CL3_BeltranLopez.service.DetalleUsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<UsuarioResponse> autenticarUsuario(
            @RequestParam("usuario") String usuario, @RequestParam("password") String password)throws Exception{
        try{
